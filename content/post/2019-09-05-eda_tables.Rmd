...
Tables allow you to explore and summarize data efficiently. While graphs are more intuitive for discovering relationships and trends, the tables have the advantage that without simple to perform and allow detecting the presence of errors in the tabulation of data.
...
the command table allows to create a table of 
Check the number of males and females

The general syntaxis to indicate a column or variable in R is _dataset__$__variable_
