...
I will use the `Dentists graduates`, and `Per 100 000 population` so let's filter and replace the former dataset
...
We have to choices: 
  ...
  - higlight one or few countries from the group we can use the package
...
Now enchance the table with the package `kableExtra`: 
